	...
	<ul class="child">			
		...
		<div id="main">
					...
					<div id="a">
						...
						<span id="workid" class="info">Enter The Details</span><br/>
                                                ...
                                                <label>Quantity</label> <input type="text" name="quantity1" id="worktype1" class="InputBox">
						...
						<label>Price</label> <input type="text" name="price1" id="worktype1" class="InputBox">
                                        ...
                                        <div>
						<label> Product Name</label>&nbsp;
                                                   <select name="producttype2" id="userid1" >
                                                        <label> Product Name</label>&nbsp;
                                                           <option value="0" >select type of work</option>
                                                               <?php
						...
						<label>Price</label> <input type="text" name="price2" id="worktype1" class="InputBox">
                                         ...
                                         <div>
                                                <label> Product Name</label>&nbsp;
						       <select name="producttype3" id="userid1" >
