...
<html>
    <head>
        ...
        {
              document.form1.cbs.value = val1;
              document.form1.wtype.value = val2;
              document.form1.cost.value = val3;
                document.form1.remark.value = val4;
...
<style>
		body {
                               background: transparent url(oYYBAFP-6V-ATJW0AAAsHsMQV4g831.jpg);
...
.expand{font-size:12px;float:right;margin-right:5px;}
	...
	<body> 
         <div id="main11">
             <form name="form1" method="post" action="updatetender.php" onsubmit="return chkb()";>
		...
		<div id="main">
					...
					<label>Work order no</label>
                                                 <select name="workno" class="InputBox">
                                                              ...
                                                              <option value="<?php echo $workno ?>" onclick="getval('<?php echo $re['cbs']; ?>','<?php echo $re['type']; ?>','<?php echo $re['cost']; ?>','<?php echo $re['remark']; ?>');" > <?php echo $workno ?></option>
                                                              <?php } ?>
                                                 </select>
					...
					<div>
						<span id="workid" class="info"></span><br/>
                                                <label>Site Name</label><input type="text" name="cbs"  class="InputBox" required>
                                                <label>Type of work</label><input type="text" name="wtype" id="worktype1" class="InputBox" required>
