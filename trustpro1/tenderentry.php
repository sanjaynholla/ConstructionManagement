	...
	<ul class="child">			
		...
		<div id="main">
					...
					<div id="a">
						...
						<label>Work Order No</label><input type="text" size="18" name="workid" id="worktype1" class="InputBox">
						<label>Tender Cost</label> <input type="text" name="cost" id="worktype1" class="InputBox">
					...
					<div>
						...
						<label>Name Of Site</label><input type="text" name="cbs"  class="InputBox">
						<label>Type of work</label><input type="text" size="19" name="wtype" id="worktype1" class="InputBox">
					</div>
