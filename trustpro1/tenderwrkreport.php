...
<center>    <table id="tble">
        ...
        <?php              
                        ...
                        print"<pre><font color='blue'>Search Records Using Work Order Number</font>     <input type='text' name='wno' align='center'>  <input type='submit' value='SEARCH'></pre>";
                        print"</form>";
                        
                         print"<form action='delete.php' method='post' name='e'>";
                          print"<pre><font color='red'>Delete Records Using Work Order Number</font>     <input type='text' name='wno' align='center'>  <input type='submit' value='DELETE'></pre>";
                          print"</form>";  
        ?> 
    </body>
</html>