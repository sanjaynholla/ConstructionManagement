...
<?php
   ...
   ?>
    ...
    ?>
     ...
     ?>
         ...
         <table id="tble">
        <tr>  <th>work no</th><th>Date </th><th>Site Name</th> <th>Labour</th> <th>Labour cost</th> <th>Labour no</th><th>Labour Total Cost</th> </tr>
 ...
 <?php
    ...
    ?>
       <table id="tble">
           <th>Work Number</th><th>Type Of Work</th><th>Site Name</th><th>Total Tender Cost</th> <th>Emd</th>  <th>Security Deposit</th><th>Income Tax</th><th>Royalty</th><th>Nsc</th><th>Sales Tax</th><th>Total Labour Payment</th><th>Total Products Cost</th><th>Vehicle Expence</th><th>Total Expenditure</th><th>Balance In Your Tender Cost</th>
           <?php
             print"<h1><color =silver>CONTENTS INTHE DATABASE</font></h1>";
             $info1=  mysql_fetch_array($data1);
               $info=  mysql_fetch_array($data);  
                $totalexp= $info[3]+$info[4]+$info[5]+$info[6]+$info[7]+$info[9]+$info[31]+$info[28]+$info1[6];
    ...
    ?>
     ...
     <?php 
        ...
        {
            $balance=0-$balance;
            echo "<h1><font color='Green'> you get loss of rupeese '$balance!!'</font>";
        }
         if($balance > 0)
        {
            echo "<font color='Medium Blue'><h1> you get Profit of rupeese '$balance!!'</font>";
        }
