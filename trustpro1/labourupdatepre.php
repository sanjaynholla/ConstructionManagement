...
<html>
	<head>
        ...
        function getval(val1,val2,val4,val5,val6)
        {
              document.form3.date.value = val1;
              document.form3.sitename.value = val2;
              
              document.form3.labour.value = val4;
              document.form3.labourno.value = val5;
               document.form3.labourcost.value = val6;
...
.expand{font-size:12px;float:right;margin-right:5px;}
	...
	<body>
            ...
            <form name="form3" method="post" action="laboursave.php">
	...
	<ul class="child">			
        ...
        <li class="parent"><a href="about.php"> About </a>
                ...
                <pre><font  size="4px"><center><h1>LABOUR UPDATE</h1></center></font></pre>
		...
		<div id="main">
					...
					<div id="a">
						...
						<span id="workid" class="info"></span><br/>
                                                <label>Date of Work</label><input type="date" name="date" placeholder="Year/Month/Date"id="userid1" class="InputBox">
					...
					<div>
						...
						<label>Work order no</label>
                                                <select  name="workno" class="InputBox"  required>
                                                              ...
                                                              <option value="<?php echo $workno; ?>" onclick="getval('<?php echo $re['dat']; ?>','<?php echo $re['sitena']; ?>','<?php echo $re['labour']; ?>','<?php echo $re['labourno']; ?>','<?php echo $re['labourco']; ?>');" > <?php echo $workno ?></option>
                                                              <?php } ?>
                                                </select>
						<label>Labour cost</label> <input type="text" name="labourcost" id="worktype1" class="InputBox">
                                        ...
                                        <div>
						<span id="worktype" class="info"></span><br/>
                                                <label>No of Labours</label><input type="text" size="16" name="labourno" id="worktype1" class="InputBox"  required>
