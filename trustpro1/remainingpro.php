...
<html>
	<head>
        ...
        function getval(val1,val2,val3,val4,val5,val6,val7,val8,val9)
        {
              document.form2.product1.value = val1;
              document.form2.quantity1.value = val2;
         
              document.form2.unit1.value = val3;
                  document.form2.product2.value = val4;
              document.form2.quantity2.value = val5;
              document.form2.unit2.value = val6;
              
               document.form2.product3.value = val7;
                  document.form2.quantity3.value = val8;
              document.form2.unit3.value = val9;
        }
</script>
		...
		<div id="main">
                    <div>       
						<span id="worktype" class="info"></span><br/>
                                                <label>Work order no &nbsp;</label>
                                                 <select  name="workno">
                                                              <option value="0" >Select Work Order Number</option>
                                                               <?php
                                                              ...
                                                              <option value="<?php echo $workno; ?>" onclick="getval('<?php echo $re['11']; ?>','<?php echo $re['12']; ?>','<?php echo $re['14']; ?>','<?php echo $re['15']; ?>','<?php echo $re['16']; ?>','<?php echo $re['17']; ?>','<?php echo $re['19']; ?>','<?php echo $re['20']; ?>','<?php echo $re['21']; ?>');"> <?php echo $workno ?></option>
                                                              <?php } ?>
                                                </select>
					</div>
					...
					<div id="a">
						...
						<span id="workid" class="info"></span><br/>
                                                ...
                                                <input type="text" name="product1" class="InputBox">
						...
						<span id="worktype" class="info"></span><br/>
                                                 ...
                                                 <label>Product Name</label>
                                                  <input type="text" name="product2" class="InputBox">
						...
						<span id="worktype" class="info"></span><br/>
                                                 ...
                                                 <label>Product Name</label>
                                              <input type="text" name="product3" class="InputBox">
