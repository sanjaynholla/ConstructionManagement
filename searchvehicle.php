...
.expand{font-size:12px;float:right;margin-right:5px;}
	...
	<ul id="menu">
        ...
        <li class="parent"><a href="inventaryentry.php">Inventary Details</a>
	...
	<ul class="child">			
        ...
        <li class="parent"><a href="tenderwrkreport.php">Work report</a>
            ...
            <ul class="child">
                ...
                <li><a href="inventaryreport.php">INVENTARY REPORT</a></li>
  ...
  <?php
       ...
       $wno=$_POST['wno'];
       $data=  mysql_query("select * from vehicle where workno='$wno'") or die("could'nt select");
...
<html>
    ...
    <table id="tble">
        ...
        <a href="vehiclereport.php"> GO BACK TO PREVIOUS REPORT PAGE </a><br><br>
        <a href="vehicledetails.php"> GO TO INVENTARY HOME PAGE  </a>
