...
<html>
    ...
    <body><center>
    <table id="tble">
        <tr>  <th>Work Order No</th><th>Date</th><th>Site Name</th> <th>Labour</th> <th>Labour Cost</th> <th>No Of Labour</th><th>Total Cost</th> </tr>
        
        
           <?php
             print"<h1><font color = red>CONTENTS IN THE LABOUR DATABASE</font></h1>";
        ...
        <?php } ?>
           ...
           <?php              
                        ...
                        print" </n>";
                          print"<form action='labourupdatepre.php' method='post' name='r'>";
                        ...
                        print"<form action='searchlabour.php' method='post' name='s'>";
